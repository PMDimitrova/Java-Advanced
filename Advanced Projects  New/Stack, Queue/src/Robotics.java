...
//robot - product -> Name, Product, Start time
//product every second
//first product = start time + 1 sec
...
public class Robotics {
    public static void main(String[] args) {
        ...
        LinkedHashMap<String, Integer> robots = getLinkedHashMap(inputRobot);   //РОБОТИ
        ...
        ArrayDeque<String> products = new ArrayDeque<>();           //ПРОДУКТИ
